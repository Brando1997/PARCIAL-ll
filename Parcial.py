    ...
    def run(self):
        while True:
            try:
                ...
                print(f"El Barbero {self.ID} esta dormido... Zzz... ")
                with self.condicion:
                    self.condicion.wait()
            else:
...
class Cliente(threading.Thread):
    ...
    def cortar(self, id_barbero):
        ...
        self.corte()
        print(f"\nEl Barbero {id_barbero} termino de cortarle el pelo al cliente {self.ID}\n")
        self.atendido.set()
...
if __name__== "__main__":
    ...
    print("\nLa Barberia a cerrado gracias por venir.\n")
